...
<body>
    ...
    <!--EndofNavigationBar-->
   	...
   	<br>
   	<h1 style="margin-left:1em; font-family:'Montserrat'; font-weight:800">Hurray <%= name %>!</h1>
   	 <hr><br>
   	 <%-- <%
			...
			<div style="align-self:flex-end; margin-top:2em; margin-bottom:1em; margin-right: 1em">
				<button class="btn btn-success"  style="font-family:'Montserrat'; color:#fff;">Proceed</button>
			</div>
			<% }
			  	else{ %>
			...
			<%} %> --%>
			<div style="flex:1; display:flex; flex-direction:column; justify-content:center; align-items:center;">
						<h1 style="font-family: 'Montserrat'; "><i class="fas fa-check-circle text-success"></i> Your order has been placed!</h1>
					<a href="userMenu.htm" class="btn btn-primary btn-block" style="width:10em; margin-top:2em;">Explore</a>
					</div>
